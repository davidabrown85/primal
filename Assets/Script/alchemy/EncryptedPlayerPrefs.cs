...
public class EncryptedPlayerPrefs  {
	// Written by Sven Magnus  (from [url]http://forum.unity3d.com/threads/playerprefs-encryption.26437/[/url])
	// MD5 written by Matthew Wegner (from [url]http://www.unifycommunity.com/wiki/index.php?title=MD5[/url])
	

	private static string privateKey = "AUniqueEncryptionKey";

	public static string[] keys = new string[] { "123Wrudre", "2SP9DupHa", "3frA5rAS3", "4tHat2epr", "5jaw3eDAs" };
	...
	public static void SaveEncryption( string key, string type, string value ) {
		...
		Debug.Log( "PlayerPrefs.SetString(" + key + "_encryption_check," +check );
		Debug.Log( "PlayerPrefs.SetInt(" + key + "_used_key," + keyIndex );
	}
